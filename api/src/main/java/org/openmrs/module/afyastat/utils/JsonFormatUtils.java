...
public class JsonFormatUtils {
	 ...
	 * object passed as the first argument is an instance of <code>{@link JSONObject}</code>.
	 * 
	 ...
	 * @return the boolean value in the json object. When the path is invalid, by default will
	 *         return false.
	 */
	...
	/**
	 * Write numeric value into the json object. The method will only write the numeric value if the
	 * object passed as the first argument is an instance of <code>{@link JSONObject}</code>.
	 * 
	 * @param object the <code>{@link JSONObject}</code> object
	 * @param path the path in the object.
	 ...
	 * @param jsonObject the json object.
	 * @param path the path inside the json object.
	 * @return the numeric value in the json object. When the path is invalid, by default will
	 *         return 0.
	 */
	...
	/**
	 * Write string value into the json object. The method will only write the string value if the
	 * object passed as the first argument is an instance of <code>{@link JSONObject}</code>.
	 * 
	 * @param object the <code>{@link JSONObject}</code> object
	 * @param path the path in the object.
	...
	/**
	 * Utility method for parsing LinkedHashMap return by calling jsonutil.readAsObject to a
	 * net.minidev.JSONObject.
	 * 
	 * @param hashMap LinkedHashMap
	 * @return net.minidev.JSONObject
	 * @see JsonFormatUtils readAsObject
	 */
	...
	/**
	 * Write date value into the json object. The method will only write the date value if the
	 * object passed as the first argument is an instance of <code>{@link JSONObject}</code>.
	 * Internally, the date will be converted into string following the ISO-8601 format and write
	 * the value to the json object. If the date is null, will write null value instead of empty
	 * string.
	 * 
	 * @param object the <code>{@link JSONObject}</code> object
	 * @param path the path in the object.
	...
	public static void writeAsDateTime(final Object object, final String path, final Date value) {
		if (object instanceof JSONObject) {
			...
			if (value != null) {
				...
				dateValue = ISO8601StandardUtil.fromCalendar(calendar);
			}
	...
	/**
	 * Read date value from the json object. The value for the path must conform to the ISO-8601
	 * standard date format.
	 * 
	 * @param jsonObject the json object.
	 * @param path the path inside the json object.
	 * @return the date value in the json object. When the path is invalid, by default will return
	 *         null.
	...
	public static Date readAsDateTime(final String jsonObject, final String path) {
		...
		try {
			...
			Calendar calendar = ISO8601StandardUtil.toCalendar(dateAsString);
	 ...
	 * @param jsonObject the json object.
	 * @param path the path inside the json object.
	 * @return the object value in the json object. When the path is invalid, by default will return
	 *         null.
	 */
	 ...
	 * @param jsonObject the json object.
	 * @param path the path inside the json object.
	 * @return the list of object values in the json object. When the path is invalid, by default
	...
	/**
	 * Write the day string of the date value into the json object. The method will only write the
	 * date value if the object passed as the first argument is an instance of
	 * <code>{@link JSONObject}</code>. Internally, the date will be converted into string of format
	 * yyyy-MM-dd without considering the timezone of the date. If the date is null, will write null
	 ...
	 * @param jsonObject the json object.
	 * @param path the path inside the json object.
	 * @return the date Time value in the json object. When the path is invalid, by default will
	 *         return null.
	 */
	public static Date readAsDateTime(final String jsonObject, final String path, final DateFormat dateFormat,
	        final String jsonPayloadTimezone) {
		Date returnedDate = null;
		try {
			String dateAsString = readAsString(jsonObject, path);
