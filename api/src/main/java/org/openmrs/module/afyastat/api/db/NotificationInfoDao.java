...
public interface NotificationInfoDao extends AfyaDataDao<NotificationInfo> {
	 ...
	 */
	List<NotificationInfo> getNotificationsByReceiver(final Person person, final String search, final Integer pageNumber,
	 ...
	 */
	List<NotificationInfo> getNotificationsBySender(final Person person, final String search, final Integer pageNumber,
	        final Integer pageSize, final String status, final Date syncDate);
	...
	List<NotificationInfo> getNotificationsByRole(Role role, String search, Integer pageNumber, Integer pageSizeInteger,
	        final String status);
