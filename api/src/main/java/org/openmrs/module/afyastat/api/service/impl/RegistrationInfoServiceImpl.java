 ...
 * {@link org.openmrs.module.afyastat.api.service.RegistrationInfoService}.
 */
public class RegistrationInfoServiceImpl extends BaseOpenmrsService implements RegistrationInfoService {
	
	private final Log log = LogFactory.getLog(this.getClass());
	
	private RegistrationInfoDao dao;
	
	/**
	 * @param dao the dao to set
	 */
	public void setDao(RegistrationInfoDao dao) {
		this.dao = dao;
	}
	 ...
	 * @return the dao
	 */
	public RegistrationInfoDao getDao() {
		return dao;
	}
	 ...
	 */
	@Override
	public RegistrationInfo getRegistrationDataByTemporaryUuid(final String temporaryUuid) {
		List<RegistrationInfo> registrationDataList = dao.getRegistrationData(temporaryUuid, StringUtils.EMPTY);
	 ...
	 */
	@Override
	public List<RegistrationInfo> getRegistrationDataByAssignedUuid(final String assignedUuid) {
