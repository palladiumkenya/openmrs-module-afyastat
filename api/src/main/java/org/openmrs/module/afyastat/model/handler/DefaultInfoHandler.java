...
public class DefaultInfoHandler implements InfoHandler {
	 ...
	 */
	@Override
	public boolean accept(final Info data) {
		return false;
	}
	 ...
	 */
	@Override
	public void handleGet(final Info data) {
	}
	 ...
	 */
	@Override
	public void handleSave(final Info data) {
	}
	 ...
	 */
	@Override
	public void handleDelete(final Info data) {
	}
}
