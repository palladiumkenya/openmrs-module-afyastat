...
/**
 *  This Handler processes relationships received from {@link org.openmrs.module.afyastat.model.AfyaDataSource} = "mobile"
 *  The handler will:
 ...
 *      <b>Throw an error to the {@link org.openmrs.module.afyastat.model.ErrorInfo} where any of this fails</b>
 *
 * @author sthaiya
 */
...
public class RelationshipQueueInfoHandler implements QueueInfoHandler {
    ...
    private void createRelationship() {
        ...
        if (p == null) {
            ...
            RegistrationInfo registrationData = registrationDataService.getRegistrationDataByTemporaryUuid(personATemporaryUuid);
            if (registrationData != null) {
        ...
        if (pb == null) {
            RegistrationInfoService registrationDataService = Context.getService(RegistrationInfoService.class);
            RegistrationInfo registrationData = registrationDataService.getRegistrationDataByTemporaryUuid(personBTemporaryUuid);
            if (registrationData != null) {
