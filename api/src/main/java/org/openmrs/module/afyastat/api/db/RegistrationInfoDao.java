...
/**
 * Database methods for {@link org.openmrs.module.afyastat.api.service.RegistrationInfoService}.
 */
public interface RegistrationInfoDao extends SingleClassInfoDao<RegistrationInfo> {
	 ...
	 */
	List<RegistrationInfo> getRegistrationData(final String temporaryUuid, final String assignedUuid);
