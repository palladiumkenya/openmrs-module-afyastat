...
public class HtmlFormToJsonSchemaFragmentController {
	...
	public SimpleObject getFormSchema(@RequestParam("formUuid") String uuid, @SpringBean KenyaUiUtils kenyaUi, UiUtils ui,
	 ...
	 */
	@AppAction("kenyaemr.afyastat.htmlToJson")
	public SimpleObject generateForms(@SpringBean KenyaUiUtils kenyaUi, UiUtils ui,
	        @SpringBean ResourceFactory resourceFactory, @SpringBean FormManager formManager) {
